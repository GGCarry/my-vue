...
<style lang="less" rel="stylesheet/less">
  .star{
    ...
    &.star-48{
      .star-item{
        width: 20px;height: 20px;margin-right: 22px;background-size: 20px 20px !important;
        &:last-child{
          margin-right: 0;
        }
        &.on{
    ...
    &.star-36{
      .star-item{
        width: 15px;height: 15px;margin-right: 6px;background-size: 15px 15px !important;
        &:last-child{
           margin-right: 0;
        }
        &.on{
    ...
    &.star-24{
      .star-item{
        width: 10px;height: 10px;margin-right: 3px;background-size: 10px 10px !important;
        &:last-child{
          margin-right: 0;
        }
        &.on{
