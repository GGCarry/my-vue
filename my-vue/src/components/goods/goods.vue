...
<style lang="less" rel="stylesheet/less">
  .goods{
    position: absolute;top: 174px;width: 100%;bottom: 46px;display: flex;overflow: hidden;
    .menu-wrapper{
      flex: 0 0 80px;width: 80px;background: #f3f5f7;
      .menu-item{
        display: table;height: 54px;width: 56px;line-height: 14px;padding: 0 12px;
        &.current{
          position: relative;margin-top: -1px;z-index: 10;font-weight: 700;background: #fff;
          .text{
            border: none;
          }
         }
        .icon{
          display: inline-block;width: 12px;height: 12px;margin-right: 2px;background-size: 12px 12px;background-repeat: no-repeat;
          &.decreace{
        ...
        .text{
          font-size: 12px;display: table-cell;width: 56px;vertical-align: middle;border-bottom: 1px solid rgba(7,17,27,0.1);
        }
      }
    }
    .foods-wrapper{
      ...
      .food-item{
        position: relative;display: flex;margin: 18px;border-bottom: 1px solid rgba(7,17,27,0.1);padding-bottom: 18px;
        &:last-child{
          border: none;margin-bottom: 0;
        }
        .icon{
          flex: 0 0 57px;margin-right: 10px;height: 57px;
        }
        .content{
          flex: 1;
          .name{
          ...
          .desc{
            margin-bottom: 8px;line-height: 10px;font-size: 10px;color: rgb(147,153,159);line-height: 12px;
          }
          .extra{
